...
4. [Configuring Cloudflare in Front](#4)
	- [Page Rules - Forwarding](#4.1)
	- [Accept Only Traffic from Cloudflare](#4.2)
	- [Transform Rules](#4.3)
5. [Summary](#5)
...
Aside from a new public URL, another side-effect of enabling static websites was the creation of a special folder named **$web**. This is the target location for static website assets sourced from this repository's [`src` folder](./src).  To upload files, the **$web** folder was chosen from the [**Storage browser**](./src/images/10.png) blade.  Everything on [this screen](./src/images/11.png) was self-explanatory so the upload mechanics will not be discussed here in detail.  Once all the assets were uploaded, their delivery to a browser were tested *successfully* by navigating to the URL (`https://staticwebsitecloudflare.z13.web.core.windows.net`) specified on the [**Static website**](./src/images/9.png) blade.  
...
At this point, navigation to either the root domain of [`staticwebsitecloudflare.site`](http://staticwebsitecloudflare.site/) or the subdomain of [`www.staticwebsitecloudflare.site`](http://www.staticwebsitecloudflare.site/) to see the Azure static website worked.  This was good progress but there were still issues.
...
##### <a name='4.1'>Page Rules - Forwarding</a>
...
##### <a name='4.2'>Accept Only Traffic from Cloudflare</a>
